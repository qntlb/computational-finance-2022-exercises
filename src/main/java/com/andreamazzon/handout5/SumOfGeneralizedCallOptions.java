 ...
 * The options have possibly different maturities and different strikes. The
...
public class SumOfGeneralizedCallOptions extends AbstractAssetMonteCarloProduct {
	...
	private final double firstStrike;
	private final double secondStrike;

	/*
	 * The constants by which the payoffs are multiplied: in the case of a cap, they
	 * are (T_2-T_1)P(T_2;0) and (T_3-T_2)P(T_3;0). For standard call options, these
	 * constants are instead equal to one.
	 */
	private final double firstMultiplier;
	private final double secondMultiplier;

	// normally, they are 0 and 1
	 ...
	 * @param firstMultiplier,  the constant by which we multiply the payoff of the
	 *                          first call option
	 * @param secondMultiplier, the constant by which we multiply the payoff of the
	 *                          second call option
