...
import com.andreamazzon.handout7.MyDigitalCaplet;
...
/**
 * This class tests the LIBOR Market Model implementation with factor reduction by evaluating a
...
public class LMMDigitalCapletTest {
	...
	public void testDigitalCaplet() throws Exception {
		...
		final double simulationTimeStep = 0.01;// for the SIMULATION discretization
		...
		final LIBORModelMonteCarloSimulationModel myLiborMonteCarlo =  
				(LIBORModelMonteCarloSimulationModel) LIBORMarketModelConstructionWithFactorReduction
				.createLIBORMarketModel(numberOfPaths, simulationTimeStep, liborPeriodLength, liborRateTimeHorizon,
						fixingForForwards, forwardsForCurve, correlationDecayParam, 
